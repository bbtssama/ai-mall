...
>
> ★ **想快速吃透整个项目 → 直接打开 `docs/项目手册/index.html`**（多页面开发说明手册，
> 双击即用、零依赖、可离线。驾驶舱 + 8 个专题页，含三层渐进披露、真实代码引用与面试话术，
> 专为"没读过这个项目但要拿它去面试"设计）。
...
> **想快速理解整个项目 → `docs/项目手册/index.html`**（HTML 手册，非 md，不受上面的 md 归类约束）。
